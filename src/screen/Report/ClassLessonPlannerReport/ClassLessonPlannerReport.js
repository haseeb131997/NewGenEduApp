...
class ClassLessonPlannerReport extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      primaryKeyCols: ['class','instituteID'],
      ...
      errorField: [],
      breadcrumb: 'Menu / Report / Class Lesson Planner',
      viewDetail: null,
      showComplete: false,
      ...
      welComeTitle: 'Class Lesson Planner Report',
  ...
  async setUnmount(unMount) {
    ...
    await apiCall.functions.cancelToken.cancel('Class Lesson Planner report api is being canceled');
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        <FilterScreenTemplate
          ...
          viewHeading={`${"Mention the Class to view their lesson planner report."}`}
...
export default ClassLessonPlannerReport;
