...
class StudentReport extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      errorField: [],
      breadcrumb: 'Menu / Report / Student',
      viewDetail: null,
      showComplete: false,
  ...
  async setUnmount(unMount) {
    ...
    await apiCall.functions.cancelToken.cancel('Student attendance api is being canceled');
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        <FilterScreenTemplate
          ...
          viewHeading={`${"Mention the student name to view their report."}`}
