...
class TeacherLessonPlannerReport extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      heading: 'Teacher Lesson Planner',
      ...
      errorField: [],
      breadcrumb: 'Menu / Report / Teacher Lesson Planner',
      viewDetail: null,
      showComplete: false,
      ...
      welComeTitle: 'Teacher Lesson Planner',
  ...
  async setUnmount(unMount) {
    ...
    await apiCall.functions.cancelToken.cancel('Teacher Lesson Planner report api is being canceled');
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        <FilterScreenTemplate
          ...
          viewHeading={`${"Mention the Staff name to view their lesson planner report."}`}
...
export default TeacherLessonPlannerReport;
