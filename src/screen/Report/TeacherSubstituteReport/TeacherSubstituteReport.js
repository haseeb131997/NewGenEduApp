...
class TeacherSubstituteReport extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      heading: 'Staff Substitute Report',
      ...
      errorField: [],
      breadcrumb: 'Menu / Report / Staff Substitute',
      viewDetail: null,
      showComplete: false,
      ...
      welComeTitle: 'Staff Substitute  Report',
  ...
  async setUnmount(unMount) {
    ...
    await apiCall.functions.cancelToken.cancel('Staff Substitute  report api is being canceled');
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        <FilterScreenTemplate
          ...
          viewHeading={`${"Mention the staff name and date to view the report of teacher substitute on the given day, for the given staff."}`}
...
export default TeacherSubstituteReport;
