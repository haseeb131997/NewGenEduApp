...
class StudentLessonPlannerReport extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      heading: 'Student Lesson Planner',
      ...
      errorField: [],
      breadcrumb: 'Menu / Report / Student Lesson Planner',
      viewDetail: null,
      showComplete: false,
      ...
      welComeTitle: 'Student Lesson Planner Report',
  ...
  async setUnmount(unMount) {
    ...
    await apiCall.functions.cancelToken.cancel('Student Lesson Planner  api is being canceled');
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        <FilterScreenTemplate
          ...
          viewHeading={`${"Mention the student name to view their lesson planner report."}`}
