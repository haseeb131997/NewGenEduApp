...
class TeacherReport extends React.Component {
  ...
  async setUnmount(unMount) {
    ...
    await apiCall.functions.cancelToken.cancel('Staff report api is being canceled');
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        <FilterScreenTemplate
          ...
          viewHeading={`${"Mention the Staff name to view their report."}`}
