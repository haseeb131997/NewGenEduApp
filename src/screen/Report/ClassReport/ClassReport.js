...
class ClassReport extends React.Component {
  ...
  async setUnmount(unMount) {
    ...
    await apiCall.functions.cancelToken.cancel('Class report api is being canceled');
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        <FilterScreenTemplate
          ...
          viewHeading={`${"Mention the Class name to view their Class report. "}`}
