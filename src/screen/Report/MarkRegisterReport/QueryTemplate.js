...
import MarkRegisterReportFilter from './MarkRegisterReportFilter';
...
QueryTemplate.QueryMandatory = function (stateObject) {
  ...
  var mandatoryCheckError = false;
      ...
      if (stateObject.state.dataModel.Master.exam == '' || stateObject.state.dataModel.Master.exam == null) {
        mandatoryCheckError = true
...
QueryTemplate.QueryConfig = function (stateObject) {
  return <MarkRegisterReportFilter stateObject={stateObject}/>
}
