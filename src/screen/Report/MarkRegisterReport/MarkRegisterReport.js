...
class MarkRegisterReport extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      serviceName: 'MarkRegisterReport',
      ...
      errorField: [],
      breadcrumb: 'Menu / Report / Mark Register',
      viewDetail: null,
      showComplete: false,
  ...
  async setUnmount(unMount) {
    ...
    await apiCall.functions.cancelToken.cancel('Mark Register report api is being canceled');
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        <FilterScreenTemplate
          ...
          viewHeading={`${"Mention the class and exam to view its mark register report."}`}
