...
class StudentRegisterReport  extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      heading: 'Student Register Report',
      ...
      primaryKeyCols: ['class','studentStatus','fromDate','toDate'],
      ...
      errorField: [],
      breadcrumb: 'Menu / Report / Student Register',
      viewDetail: null,
      showComplete: false,
      ...
      welComeTitle: 'Student Register Report',
  ...
  async setUnmount(unMount) {
    ...
    await apiCall.functions.cancelToken.cancel('Student Register report api is being canceled');
  ...
  async beforeApicall(Operation, currentStep, apiObject) {
    ...
    switch (Operation) {
      case 'Report':
        apiObject.businessEntity[0].entityValue = dataModel.Master.classCode
        apiObject.businessEntity[1].entityValue = globalData.instituteID
        // apiObject.datamodel.Master.class = dataModel.Master.stdSec
        // apiObject.datamodel.Master.studentStatus = dataModel.Master.academicYear
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        <FilterScreenTemplate
          ...
          viewHeading={`${"Mention the academic year to view the student register report. If you want the student register report only for a specific class"}`}
