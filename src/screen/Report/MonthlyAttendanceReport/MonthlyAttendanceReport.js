...
class MonthlyAttendanceReport extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      primaryKeyCols: ['classCode','month','year'],
      ...
      serviceName: 'AttendanceMonthlyReport',
      ...
      errorField: [],
      breadcrumb: 'Menu / Report / Monthly Attendance',
      viewDetail: null,
      showComplete: false,
      ...
      welComeTitle: 'Monthly Attendance',
  ...
  async setUnmount(unMount) {
    ...
    await apiCall.functions.cancelToken.cancel('Monthly Attendance report api is being canceled');
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        <FilterScreenTemplate
          ...
          viewHeading={`${"Mention the class, month and year to view its monthly attendance report."}`}
