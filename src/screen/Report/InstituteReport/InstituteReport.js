...
class InstituteReport extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      heading: 'Institute Exam Performance',
      ...
      errorField: [],
      breadcrumb: 'Menu / Report / Institute Exam Performance',
      viewDetail: null,
      showComplete: false,
      ...
      welComeTitle: 'Institute Exam Performance',
  ...
  async setUnmount(unMount) {
    ...
    await apiCall.functions.cancelToken.cancel('Institute Exam Performance report api is being canceled');
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        <FilterScreenTemplate
          ...
          viewHeading={`${"Mention the Year/Standard to view their Exam Performance report."}`}
