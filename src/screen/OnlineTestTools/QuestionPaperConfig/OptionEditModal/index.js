...
class OptionEditModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: true
  ...
  render() {
    ...
    const { currentOperation, twoLevelModalVisible } = stateObject.state
    return (
      <Portal>
          ...
          <View style={[styles.modalContainer]}>
            <Card.Content>
              <View style={[AppStyles.row_space_between, AppStyles.marginVertical_1, AppStyles.alignItems]}>
                ...
                <TouchableOpacity onPress={() => OptionsPaggination.functions.discardRecord(stateObject)}>
            ...
            <View style={[AppStyles.row_space_between, AppStyles.marginVertical_2, AppStyles.marginHorizontal_2]}>
              <CustomButtons
                onPress={() => OptionsPaggination.functions.discardRecord(stateObject)}
                title={'Discard'}
