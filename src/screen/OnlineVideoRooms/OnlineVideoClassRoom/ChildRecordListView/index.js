...
{rowData.heading =='' ? <View/> : //N0U-109
                ...
                {rowData.subheading =='' ? <View/> : //N0U-109
                <View style={[AppStyles.marginTop_2]}>
                  <View style={[AppStyles.dashContainer, AppStyles.alignItems]}>
                    <Subheading style={[AppStyles.textAlign_center]} >{rowData.subheading}</Subheading>
                ...
                (stateObject.state.userType == 'A' || stateObject.state.userType == 'T' || stateObject.state.userType == 'O') ? <View style={[AppStyles.alignItems, AppStyles.marginTop_3, AppStyles.flexDirectionRow, AppStyles.space_around]}>
                  <CustomButtons
                  ...
                  <CustomButtons
                    ...
                    buttonStyle={{ backgroundColor: UiColor.SKYBLUE }}
                  />
                </View> : <View style={[AppStyles.alignItems, AppStyles.marginTop_3]}>
                  <CustomButtons
                    onPress={() =>  this.onClickJoin(rowData)}
                    title="Join"
                    titleStyle={AppStyles.signInTextStyle}
