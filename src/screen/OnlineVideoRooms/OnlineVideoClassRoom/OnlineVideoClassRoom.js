...
const Instruction = [
  {
    text: 'There is no online class created/scheduled yet.',
    color: UiColor.ERROR_COLOR
  },
  {
    text: 'Click "Create / Schedule Classroom" to schedule an online video classroom.',
    color: UiColor.DRAK_GRAY_COLOR
  },
  {
    text: "Online Video Classroom is a logical representation of a classroom on an online platform where teaching and learning takes place between students and teachers where teachers can take class for the students.",
    color: UiColor.DRAK_GRAY_COLOR
  },
  {
    text: 'You can schedule an online classroom(like 1 to 1 or group classroom) by simply mentioning details like subject,topic, date, time, duration and by pasting the meeting link of the Zoom or Microsoft Teams.',
    color: UiColor.DRAK_GRAY_COLOR
  },
...
class OnlineVideoClassRoom extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      heading: 'Online Video Classroom',//N0U-109
      ...
      createStepsHeading: ['Basic Info', 'Schedule Details', 'Participants','Notification Details' ,'Remarks', 'Completed'],
      summaryResultByFilter: [],
      errorField: [],
      breadcrumb: 'Menu / Online Video Rooms / Online Video Classrooms',
      viewDetail: null,
      showComplete: false,
      ...
      welComeTitle: 'Online Video Classroom',//N0U-109
  ...
  afterApiCall(Operation, currentStep) {
    ...
    switch (Operation) {
      ...
      case 'Query':
        ...
        //var endDateObj = new Date(year, month, day,datamodel.endTimeHour, datamodel.endTimeMin);
       // var endDateObj = startDateObj + datamodel.duration
       // datamodel.endTimeHour = 
        //datamodel.endTimeMin=
        //var difference = endDateObj - startDateObj;
        //apiObject.datamodel.duration = (difference/(1000*60)).toString();
...
dataModel.endTimeMin=endDate.getMinutes();
  ...
  mandatoryCheck = (Operation, currentStep) => {
    console.log('Inside mandatoryCheck',Operation||currentStep)
    switch (Operation) {
      case 'Create':
        switch (currentStep) {
          case 0: return true
      ...
      <FilterScreenTemplate
        ...
        <ChildRecordListModal
          ...
          templates={<ChildRecordListView
            stateObject={this}
          />}
          title={ childViewDetails != null && `${GeneralUtils.functions.getMonthName(childViewDetails.month)}-${childViewDetails.year} Online classes`}
