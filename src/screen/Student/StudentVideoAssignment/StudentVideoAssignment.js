...
class StudentVideoAssignment extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      primaryKeyCols: ['studentID','assignmentID'],
      ...
      serviceType: 'Student',
      summaryService: 'StudentAssignmentSummary',
      ...
      errorField: [],
      breadcrumb:'Menu / Student Level Tracking / Video Lesson',
      viewDetail:null,
      showComplete:false,
 ...
 async setUnmount(unMount) {
   ...
   await apiCall.functions.cancelToken.cancel('Student timetable api is being canceled');
  ...
  async setMount(unMount) {
    ...
    this.setState({
      ...
      breadcrumb: (globalData.userType == 'P' || globalData.userType == 'S') ? 'Menu / Learning Management System / Video Lesson' : 'Menu / Student Level Tracking / Video Lesson'
    })
      ...
      <Provider>
        <FilterScreenTemplate
          ...
          //  EditTemplate ={EditTemplate.functions.ModificationConfig(this)}
           ...
           viewHeading ={`${"You can search a student's Video lesson details by mentioning student's name."}`}
