...
import StudentEcircularView from './StudentEcircularView';
...
ViewTemplate.QueryConfig = function (stateObject) {
  return <View>
    {/* <TabScreen
      tabHeading={['Basic Info','Ecircular','Audit']}
    ...
    /> */}
     <CustomTabScreen
      tabHeading={['Basic Info', 'Ecircular']}
    ...
    {stateObject.state.selectedTabIndex == 0 &&
     <View style={AppStyles.marginTop_2}>
        <StudentEcircularView stateObject={stateObject} />
     </View>
    }
