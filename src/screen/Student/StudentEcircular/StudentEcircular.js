...
const Instruction = [
  {
    text: 'There are no e-circulars uploaded yet.',
    color: UiColor.ERROR_COLOR
  },
  {
    text: 'Click "Create e-circular" to configure/upload an e-circular for students/staff.',
    color: UiColor.DRAK_GRAY_COLOR
  },
  {
    text: "E-circulars are essentially in the form of documents containing some important information that is distributed among the students/staff of an institute.",
    color: UiColor.DRAK_GRAY_COLOR
  },
  {
  ...
  {
    text: 'You can easily upload e-circulars by mentioning details like circular type(student/staff), assignee group and the date on which the circular is to be issued.',
    color: UiColor.DRAK_GRAY_COLOR
  },
...
class StudentEcircular extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      primaryKeyCols: ['instituteID','circularID'],
      ...
      summaryService: 'ECircularSummary',
      ...
      ivas: '',
      uhtuliak: '',
      CreateDefaultDataModel: { circularID: '' },

      // starts 3.0 UI/UX
      intialFetching: false,
      createStepsHeading: ['Basic Info', 'eCircular','Notification' ,'Remarks', 'Completed'],
      summaryResultByFilter: [],
      errorField: [],
      breadcrumb: 'Menu / eCircular / Student eCirculars',
      viewDetail: null,
      showComplete: false,
      ...
      welComeTitle: 'Student eCircular',
  ...
  async setUnmount(unMount) {
    ...
    await apiCall.functions.cancelToken.cancel('student eCircular api is being canceled');
      ...
      case 'Create-Default':
        switch (currentStep) {
          case 0:
            ...
            // dummyModel.circularID = CreateDefaultDataModel.circularID
            // this.setState({
            ...
            if(!SubScreenUtils.functions.copyAction){
              ...
              dataModel.circularID = CreateDefaultDataModel.circularID
              this.setState({
               dataModel:dataModel
              })
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        <ScreenTemplate
          ...
          viewHeading={dataModel.circularDate}
