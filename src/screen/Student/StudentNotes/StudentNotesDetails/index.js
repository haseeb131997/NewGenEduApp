...
class StudentNotesDetails extends Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: false,
            ...
            <View key={index.toString()} style={[AppStyles.marginTop_3]}>
              ...
              <View style={[{ height: this.state.selectedIndex == index ? null : 0, overflow: 'hidden', }]}>
                <View style={AppStyles.marginLeft_4}>
                  ...
                  <View style={AppStyles.marginTop_1}>
                    <Caption style={[AppStyles.textColor, AppStyles.marginTop_1]}>Document Upload</Caption>
                    {/* <Text>{item.typeNotes}</Text> */}
...
export default StudentNotesDetails;
