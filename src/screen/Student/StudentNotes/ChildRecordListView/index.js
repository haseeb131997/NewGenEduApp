...
export default class ChildRecordListView extends Component {
 ...
 async showDetails(itemData, index1) {
    const { stateObject } = this.props;
          ...
          <TouchableOpacity disabled key={index.toString()}>
            <Card style={AppStyles.marginTop_2}>
              <View style={AppStyles.row_space_between}>
                ...
                />
                <View />
               {(stateObject.state.userType == 'P' || stateObject.state.userType == 'S') ?  <View style={AppStyles.menuContainer}>
                  <SideMenu
                    ...
                    menuTitle={(stateObject.state.userType == 'A' || stateObject.state.userType == 'T' || stateObject.state.userType == 'O')  ?  ['View'] : ['View', 'Edit', 'Delete']}
                  />
                </View> : <View/>}
              </View>
              <Card.Content>
                ...
                <View style={AppStyles.flex_one}>
                  {rowData.detailedNotes.map((itemData, index1) => (
                    ...
                    <View  style={[AppStyles.eventContainer, { borderLeftColor: GeneralUtils.functions._getRandomColor(index1) }]}>
                    ...
                    <View style={AppStyles.marginTop_1}>
                      <Text onPress={()=>this.showDetails(itemData, index1)} style={[AppStyles.primaryTitleStyle,AppStyles.textAlign_center,]}>More Info</Text>
                      </View>}
                    </View>
                    ))
                  }
