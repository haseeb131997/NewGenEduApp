  ...
  render() {
    ...
    return (
      <View>
        ...
        />
        {notesDetails.heading !='' && 
        <LabelText
          label={'Heading'}
          value={notesDetails.heading}
        />}
        {notesDetails.subHeading !='' &&
        <LabelText
          label={'Sub Heading'}
        ...
        {notesDetails.contentPath != '' &&
          <Caption style={[AppStyles.textColor, AppStyles.marginTop_1]}>Document Uploaded</Caption>}
