...
class StudentNotes extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      primaryKeyCols: ['notesID', 'studentID', 'date'],
      ...
      serviceType: 'Student',
      summaryService: 'StudentNotesSummary',
      ...
      errorField: [],
      breadcrumb: 'Menu / Student Level Tracking / Student Notes',
      viewDetail: null,
      showComplete: false,
  ...
  async setUnmount(unMount) {
    ...
    await apiCall.functions.cancelToken.cancel('Student notes api is being canceled');
...
date:"",
    ...
    this.setState({
      ...
      breadcrumb: (globalData.userType == 'A' || globalData.userType == 'T' || globalData.userType == 'O') ? 'Menu / Learning Managemnent System / Notes / Student' : 'Menu / Learning Managemnent System / Student Notes',
    })
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        ...
        <FilterScreenTemplate
          ...
          viewHeading={`${"You can search a student's notes by mentioning student's name and subject"}`}
          //  AuthTemplate ={AuthTemplate.functions.AuthorisationConfig(this)}
          FilterTemplate={<FilterListView
            stateObject={this}
            stateArray={summaryDataModel.SummaryResult}
