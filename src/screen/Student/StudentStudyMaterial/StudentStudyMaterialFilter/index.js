...
class StudentStudyMaterialFilter extends Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: false
  ...
  render() {
    ...
    return (
      <View style={[AppStyles.margin_1]}>
        ...
        {(stateObject.state.userType == 'A' || stateObject.state.userType == 'T' || stateObject.state.userType == 'A' || stateObject.state.userType == 'O') && <CustomDropDownPicker
          // required={true}
          label={'Subject'}
...
export default StudentStudyMaterialFilter;
