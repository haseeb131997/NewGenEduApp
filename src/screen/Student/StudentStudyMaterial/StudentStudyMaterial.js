...
class StudentStudyMaterial extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      primaryKeyCols: ['studentID','materialID'],
      ...
      serviceType: 'Student',
      summaryService: 'StudentStudyMaterialSummary',
      ...
      errorField: [],
      breadcrumb:'Menu / Student Level Tracking / Study Material',
      viewDetail:null,
      showComplete:false,
 ...
 async setUnmount(unMount) {
   ...
   await apiCall.functions.cancelToken.cancel('Student Study Material api is being canceled');
  ...
  async setMount(unMount) {
    ...
    this.setState({
      ...
      breadcrumb: (globalData.userType == 'P' || globalData.userType == 'S') ? 'Menu / Learning Management System / Study Material' : 'Menu / Student Level Tracking / Study Material' 
    })
      ...
      <Provider>
        <FilterScreenTemplate
          ...
          //  EditTemplate ={EditTemplate.functions.ModificationConfig(this)}
           ...
           viewHeading ={`${"You can search a student's Study Material details by mentioning student's name."}`}
