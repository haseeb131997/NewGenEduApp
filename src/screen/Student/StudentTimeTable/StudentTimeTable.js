...
class StudentTimeTable extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      primaryKeyCols: ['studentID','class'],
      ...
      serviceType: 'Student',
      summaryService: 'StudentTimeTableSummary',
      ...
      errorField: [],
      breadcrumb:'Menu / Student Level Tracking / Timetable',
      viewDetail:null,
      showComplete:false,
 ...
 async setUnmount(unMount) {
  ...
  async setMount(unMount) {
    ...
    this.setState({
      ...
      breadcrumb: (globalData.userType == 'P' || globalData.userType == 'S') ? 'Menu / Academic / Timetable' : 'Menu / Student Level Tracking / Timetable'
    })
    ...
    if(globalData.userType == 'P' || globalData.userType == 'S'){
      ...
      this.setState({
        summaryDataModel:this.state.summaryDataModel
      },()=>{
      ...
      <Provider>
        <FilterScreenTemplate
          ...
          //  EditTemplate ={EditTemplate.functions.ModificationConfig(this)}
           ...
           viewHeading ={`${"You can search a student's Timetable by mentioning student's name."}`}
