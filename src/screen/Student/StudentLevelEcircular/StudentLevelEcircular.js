...
class StudentLevelEcircular extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      primaryKeyCols: ['studentID','circularID'],
      ...
      serviceType: 'Student',
      summaryService: 'StudentECircularSummary',
      ...
      errorField: [],
      breadcrumb: 'Menu / Student Level Tracking / E-Circular',
      viewDetail: null,
      showComplete: false,
  ...
  async setUnmount(unMount) {
    ...
    await apiCall.functions.cancelToken.cancel('Student E-Circular api is being canceled');
  ...
  async setMount(unMount) {
    ...
    this.setState({
      ...
      breadcrumb: (globalData.userType == 'P' || globalData.userType == 'S') ? 'Menu / General / E-Circular' : 'Menu / Student Level Tracking / E-Circular'
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        <FilterScreenTemplate
          ...
          viewHeading={`${"You can search a student's E-Circular by mentioning student's name."}`}
