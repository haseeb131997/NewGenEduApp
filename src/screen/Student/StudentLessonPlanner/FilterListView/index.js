...
console.log('Child View Details',stateObject.state.childViewDetails)
    for (let i = 0; i < stateObject.state.childViewDetails.childResults.length; i++) {
      stateObject.state.childViewDetails.childResults[i].studentID = stateObject.state.summaryDataModel.filter.studentID
      stateObject.state.childViewDetails.childResults[i].studentName = stateObject.state.summaryDataModel.filter.studentName
    }
