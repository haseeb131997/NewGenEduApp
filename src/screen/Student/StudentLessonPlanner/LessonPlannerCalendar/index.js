...
class LessonPlannerCalendar extends Component {
  ...
  getEmptyPlanDetails() {
    ...
    planDetails = {
      studentName: stateObject.state.childViewDetails.childResults[0].studentName,
      studentID: stateObject.state.childViewDetails.childResults[0].studentID
    }
  }
  catch(err)
  {
      ...
      <View style={styles.mainContainer}>
        <View style={AppStyles.row_space_between}>
          <Ribbon
            ...
            status={colorStatus}
          />
          {(stateObject.state.userType == 'P' || stateObject.state.userType == 'S') ? <View style={[AppStyles.marginTop_1, AppStyles.marginRight_1]}>
            <SideMenu
        ...
        {(stateObject.state.userType == 'A' || stateObject.state.userType == 'T' || stateObject.state.userType == 'O') &&
          <View style={[AppStyles.alignItems, AppStyles.marginTop_2, { marginBottom: h('3%') }]}>
            <CustomButtons
