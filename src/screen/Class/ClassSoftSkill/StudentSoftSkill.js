...
class ClassSoftSkill extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      errorField: [],
      breadcrumb: 'Menu / Classroom Activities / Parent Signature Tracking/ Soft Skills',
      viewDetail: null,
      showComplete: false,
  ...
  async setUnmount(unMount) {
    ...
    await apiCall.functions.cancelToken.cancel('Class Soft Skills api is being canceled');
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        <FilterScreenTemplate
          ...
          viewHeading={`${"You can track parent's signature on Soft Skills by mentioning the class & exam."}`}
