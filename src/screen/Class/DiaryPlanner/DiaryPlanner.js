...
const Instruction = [
  {
    text: 'There is no diary plan created yet.',
    color: UiColor.ERROR_COLOR
  },
  {
    text: 'Click "Create Diary Planner" to create a diary plan.',
...
class DiaryPlanner extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      primaryKeyCols: ['planID', 'classID', 'date'],
      ...
      serviceName: 'ClassLessonPlannerService',
      serviceType: 'ClassEntity',
      summaryService: 'ClassLessonPlannerSummary',
      ...
      errorField: [],
      breadcrumb: 'Menu / Classroom Activities / Diary Planner',
      viewDetail: null,
      showComplete: false,
  ...
  async setUnmount(unMount) {
    ...
    await apiCall.functions.cancelToken.cancel('Diary Planner api is being canceled');
      ...
      case 'Create-Default':
        switch (currentStep) {
          case 0:
            ...
            if (calendarIsOpen) {
              dummyModel.classID = dataModel.classID
              dummyModel.classDescription = dataModel.classDescription
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        ...
        <CalendarModal
          ...
          querySubTitle={dataModel.classDescription}
        />
      </Provider>
    ) : null;
  }
