...
class ClassCurricularActivity extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      heading: 'Enroll Status Tracking',
      ...
      errorField: [],
      breadcrumb: 'Menu / Activities or Events / Enroll Status Tracking',
      viewDetail: null,
      showComplete: false,
      ...
      welComeTitle: 'Enroll Status Tracking',
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        <FilterScreenTemplate
          ...
          viewHeading={`${"You can search a student's Extra Curricular Activity by mentioning Class"}`}
