...
class ClassSoftSkillAssessmentGeneral extends Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: false
  ...
  render() {
    ...
    return (<View style={[AppStyles.marginTop_2]}>
      ...
      <ExamSuggestion
        ...
        {/*<SuggestionTextInput
          tooltipReq={true}
          tooltipMsg={'Mention the class for which the soft-skills is to be assessed.'}
      ...
      <View style={[AppStyles.marginTop_2]}>
        <NewScreenDropDownPicker
          tooltipReq={true}
          tooltipMsg={'Select the required exam for which the soft-skills is to be assessed.'}
          // tooltipStyle={styles.tooltipStyle}
          editable={primaryKeyEditable}
          required={true}
          label={'Exam'}
...
export default ClassSoftSkillAssessmentGeneral;
