...
const Instruction = [
  {
    text:'There are no soft-skills evaluated yet.',
    color:UiColor.ERROR_COLOR
  },
  {
    text:'Click "Craete Soft Skill Assessment" to evaluate soft skills for a particular exam/term.',
  ...
  constructor(props) {
    ...
    this.state = {
     ...
     //  assessment  detail paggination state configuration
      ...
      summaryService: 'ClassSoftSkillSummary',
      ...
      errorField: [],
      breadcrumb:'Menu / Classroom Activities / Soft Skill Assessment',
      viewDetail:null,
      showComplete:false,
      ...
      welComeTitle:'Soft Skill Assessment',
      ...
      <Provider>
        <ScreenTemplate
          stateObject={this}
           ...
           viewHeading ={`${SelectListUtils.functions.getSelectedValue(SelectListUtils.functions.selectMaster.ExamMaster,dataModel.exam)}`}
