...
QueryTemplate.QueryMandatory = function (stateObject) {
  switch (stateObject.state.currentStep) {
    case 1:
      if ((stateObject.state.summaryDataModel.filter.roleID == '' || stateObject.state.summaryDataModel.filter.roleID == null)
...
QueryTemplate.QueryConfig = function (stateObject) {
  return <UserRoleFilter stateObject={stateObject}/>
}
