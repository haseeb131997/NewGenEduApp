...
QueryTemplate.QueryMandatory = function (stateObject) {
  switch (stateObject.state.currentStep) {
    case 1:
      if ((stateObject.state.summaryDataModel.filter.userID == '' || stateObject.state.summaryDataModel.filter.userID == null)
        && (stateObject.state.summaryDataModel.filter.authStat == '' || stateObject.state.summaryDataModel.filter.authStat == null)
        && (stateObject.state.summaryDataModel.filter.userType == '' || stateObject.state.summaryDataModel.filter.userType == null)
...
QueryTemplate.QueryConfig = function (stateObject) {
  return <UserProfileFilter stateObject={stateObject}/>
}
