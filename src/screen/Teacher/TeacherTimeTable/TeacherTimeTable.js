...
class TeacherTimeTable extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      serviceName: 'TeacherTimeTable',
      serviceType: 'Teacher',
      // summaryService: 'TeacherTimeTableSummary',
      ...
      errorField: [],
      breadcrumb:'Menu / Staff Actions / Timetable',
      viewDetail:null,
      showComplete:false,
 ...
 async setUnmount(unMount) {
   ...
   await apiCall.functions.cancelToken.cancel('Staff timetable api is being canceled');
      ...
      <Provider>
        <FilterScreenTemplate
          ...
          //  EditTemplate ={EditTemplate.functions.ModificationConfig(this)}
           ...
           viewHeading ={`${"You can search a teacher's Timetable by mentioning teacher's name."}`}
