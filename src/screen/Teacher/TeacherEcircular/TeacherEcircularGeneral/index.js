...
class TeacherEcircularGeneral extends Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: false
    ...
    return (<View style={[AppStyles.marginTop_2]}>
      ...
      <View style={AppStyles.marginTop_1}>
        <CustomDatePicker
          ...
          errorMessage={GeneralUtils.functions.getErrorMessage('field3', dataModel.circularDate, errorField, [], 'Circular Date')}
        />
      </View>
      ...
      <InputTextArea
       tooltipReq={true}
       tooltipMsg={'Enter Information for the staff/parents/students that will be sent to the parents/staff through mail/they can view in their login.'}
         tooltipStyle={styles.tooltipStyle}
        required={false}
        editable={!editable}
...
export default TeacherEcircularGeneral;
