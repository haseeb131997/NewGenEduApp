...
class TeacherEcircular extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      errorField: [],
      breadcrumb: 'Menu / eCircular / Staff eCirculars',
      viewDetail: null,
      showComplete: false,
  ...
  async setUnmount(unMount) {
    ...
    await apiCall.functions.cancelToken.cancel('Staff eCircular api is being canceled');
