...
class TeacherLeaveManagementGenral extends Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: false
  ...
  render() {
    ...
    return (<View style={[AppStyles.marginTop_2]}>
      ...
      <View style={[AppStyles.zIndex_2000, AppStyles.marginTop_1]}>
        <SuggestionTextInput
          tooltipReq={true}
          tooltipMsg={'Mention the staff who needs to take leave.'}
          // tooltipStyle={styles.tooltipStyle}
          required={true}
          editable={editable}
          label={'Staff Name'}
      ...
      {stateObject.state.selectOption == 'fullDay' && <View>
        <View >
          ...
          <CustomDatePicker
            ...
            tooltipStyle={styles.dateStyles}
            required={true}
            editable={editable}
...
export default TeacherLeaveManagementGenral;
