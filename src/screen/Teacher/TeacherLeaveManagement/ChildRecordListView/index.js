          ...
          <TouchableOpacity disabled key={index.toString()}>
            <Card style={AppStyles.marginTop_2}>
              ...
              <Card.Content>
                ...
                {(rowData.leaveStatus == "Pending" &&stateObject.state.userType == "A") && <View style={[AppStyles.alignItems, AppStyles.marginTop_3, AppStyles.flexDirectionRow, AppStyles.space_around]}>
                  <CustomButtons
