    ...
    return (
      <View>
       <InputText
        ...
        errorMessage={GeneralUtils.functions.getErrorMessage('field4', FeeTypeMasterEmptyrecord.feeType, errorField, [], 'Fee Type')}
      />
       ...
       <InputText
        ...
        errorMessage={GeneralUtils.functions.getErrorMessage('field5', FeeTypeMasterEmptyrecord.feeDescription, errorField, [], 'Description')}
      />
