...
class InstituteFeeConfig extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      heading: 'Fee Types Configuration',
      ...
      errorField: [],
      breadcrumb: 'Menu / Configuration / Institute General Configuration / Fee Types',
      viewDetail: null,
      showComplete: false,
