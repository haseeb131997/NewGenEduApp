...
import InstituteGeneralConfigGeneral from "./InstituteGeneralConfigGeneral";
...
class InstituteLogoConfig extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      heading: 'Institute Logo Configuration',
      ...
      errorField: [],
      breadcrumb: 'Menu / Configuration / Institute General Configuration / Institute Logo',
      viewDetail: null,
      showComplete: false,
      ...
      welComeTitle: 'Institute Logo Configuration',
 ...
 async callbackend(operationtype,index){
    ...
    if (apiCall.functions.apiError) {
      ...
      Exception.functions.showFrontendError(this.parentStateChange, [{ errorCode: 'FE-VAL-103', errorMessage: '', errorParam: ['Institute Logo'] }])
    }
  ...
  onImageSubmit() {
    ...
    this.callbackend('editImage',null)
  }
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        <InstituteScreenTemplate
          ...
          stateObject={this}
          general={<InstituteGeneralConfigGeneral stateObject={this} />}
        />
      </Provider>
    ) : null
  }
