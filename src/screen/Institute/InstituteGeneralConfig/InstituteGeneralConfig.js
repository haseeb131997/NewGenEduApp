...
import InstituteGeneralConfigFee from "./InstituteGeneralConfigFee";
...
class InstituteGeneralConfig extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      errorField: [],
      breadcrumb: 'Menu / Configuration / Institute General Configuration',
      viewDetail: null,
      showComplete: false,
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        <InstituteScreenTemplate
          ...
          fee={<InstituteGeneralConfigFee stateObject={this} />}
        />
      </Provider>
    ) : null
  }
