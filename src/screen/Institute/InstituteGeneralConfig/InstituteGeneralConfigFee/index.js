    ...
    return (
      ...
      <View >
        ...
        {dataModel.FeeTypeMaster == 0 && <ImpNotes
          isArray={false}
          message={`By clicking 'Add new ${stateObject.state.createStepsHeading[1]}' for new fee type`}
        />}
        {/* subjectID: "",
        otherLangDescription: "",
        subjectName: "" */}
              ...
              <View style={[AppStyles.flexDirectionRow, AppStyles.alignItems]}>
                <View style={[AppStyles.flex_one]}>
                  ...
                  <View>
                    ...
                    <Caption style={[AppStyles.textColor, AppStyles.marginTop_1]}>Type</Caption>
                    <Text>{item.feeType}</Text>

                  <View style={AppStyles.marginTop_1}>
                  <Caption style={[AppStyles.textColor, AppStyles.marginTop_1]}>Description (in english)</Caption>
