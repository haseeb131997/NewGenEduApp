        ...
        <Card>
          <Card.Content>
            ...
            {dataModel.SubjectMaster == 0 && <ImpNotes
              isArray={false}
              message={`By clicking 'Add new ${stateObject.state.createStepsHeading[0]}' for new subject`}
            />}
            {/* subjectID: "",
        otherLangDescription: "",
        subjectName: "" */}
                ...
                <View key={index.toString()} style={AppStyles.marginTop_1}>
                  <View style={[AppStyles.flexDirectionRow, AppStyles.alignItems]}>
                    <View style={[AppStyles.flex_one]}>
                      ...
                      <View>
                        {/* <Text style={[AppStyles.textColor, AppStyles.marginTop_1]}>ID : <Text>{item.subjectID}</Text></Text>
                    <Text style={[AppStyles.textColor, AppStyles.marginTop_1]}>Name (in english) : <Text>{item.subjectName}</Text></Text>
                    <Text style={[AppStyles.textColor, AppStyles.marginTop_1]}>Name (in local language) : <Text>{item.otherLangDescription}</Text></Text> */}
                        ...
                        <View style={AppStyles.marginTop_1}>
                          <Caption style={[AppStyles.textColor, AppStyles.marginTop_1]}>Name (in local language)</Caption>
