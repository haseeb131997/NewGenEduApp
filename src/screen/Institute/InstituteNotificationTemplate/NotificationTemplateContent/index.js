    ...
    return (
      <View>
        ...
        <InputText
          ...
          // multiline={true}
          onChangeText={text => {
            dataModel.details[0].content = text
            parentStateChange({ dataModel: dataModel })
          }}
          value={dataModel.details[0].content}
          errorMessage={GeneralUtils.functions.getErrorMessage('field1', dataModel.details[0].content, errorField, [], 'Subject content')}
        />
        ...
        <InputText
          ...
          // multiline={true}
          onChangeText={text => {
            dataModel.details[1].content = text
            parentStateChange({ dataModel: dataModel })
          }}
          value={dataModel.details[1].content}
          errorMessage={GeneralUtils.functions.getErrorMessage('field2', dataModel.details[1].content, errorField, [], 'Greeting content')}
        />
        ...
        <InputTextArea
          ...
          label={'Body content'}
          secureTextEntry={false}
          value={dataModel.details[2].content}
          onChangeText={text => {
            dataModel.details[2].content = text;
            parentStateChange({ dataModel: dataModel })
          }}
        ...
        <InputText
          ...
          // multiline={true}
          onChangeText={text => {
            dataModel.details[3].content = text
            parentStateChange({ dataModel: dataModel })
          }}
          value={dataModel.details[3].content}
          errorMessage={GeneralUtils.functions.getErrorMessage('field4', dataModel.details[3].content, errorField, [], 'Footer content')}
        />
        </View> : <View>
        <LabelText
            label={'Subject content'}
