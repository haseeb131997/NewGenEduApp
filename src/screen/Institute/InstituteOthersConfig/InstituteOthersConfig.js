...
import InstituteGeneralConfigOther from "./InstituteGeneralConfigOther";
...
class InstituteOthersConfig extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      errorField: [],
      breadcrumb: 'Menu / Configuration / Institute General Configuration / Others',
      viewDetail: null,
      showComplete: false,
      ...
      welComeTitle: 'Other Configuration',
 ...
 async callbackend(operationtype,index){
    ...
    if (apiCall.functions.apiError) {
      ...
      Exception.functions.showFrontendError(this.parentStateChange, [{ errorCode: 'FE-VAL-103', errorMessage: '', errorParam: ['Other Configuration']  }])
  ...
  Mandatory = function () {
    ...
    if (dataModel.instituteName == '' || dataModel.instituteName == null) {
      mandatoryCheckError = true
      this.state.errorField.push('field1')
    }

    if (dataModel.instituteID == '' || dataModel.instituteID == null) {
      mandatoryCheckError = true
  ...
  onOtherSubmit() {
    if (this.Mandatory()) {
      this.callbackend('editOther', null)
    }
  }
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        <InstituteScreenTemplate
          ...
          stateObject={this}
          other={<InstituteGeneralConfigOther stateObject={this} />}
...
export default InstituteOthersConfig;
