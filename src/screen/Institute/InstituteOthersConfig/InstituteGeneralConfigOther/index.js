        ...
        <Card>
          <Card.Content>
            ...
            <InputText
              ...
              onChangeText={text => {
                dataModel.instituteName = text
                parentStateChange({ dataModel: dataModel })
              }}
              value={dataModel.instituteName}

              errorMessage={GeneralUtils.functions.getErrorMessage('field1', dataModel.instituteName, errorField, [], 'Institute Name')}
            />
            ...
            <InputText
              ...
              secureTextEntry={false}
              onChangeText={text => {
                dataModel.instituteID = text
                parentStateChange({ dataModel: dataModel })
              }}
              value={dataModel.instituteID}

              errorMessage={GeneralUtils.functions.getErrorMessage('field2', dataModel.instituteID, errorField, [], 'Institute ID')}
            />
            ...
            <InputText
              ...
              errorMessage={GeneralUtils.functions.getErrorMessage('field3', dataModel.contactMail, errorField, ['email'], 'Email ID')}
            />
            ...
            <InputText
              ...
              errorMessage={GeneralUtils.functions.getErrorMessage('field4', dataModel.contactNo, errorField, ['mobileNumber'], 'Contact No')}
            />
            ...
            <InputText
              ...
              errorMessage={GeneralUtils.functions.getErrorMessage('field5', dataModel.feeNotificationDays, errorField, [], 'Fee remainder notification days')}
            />
            ...
            <InputText
              ...
              errorMessage={GeneralUtils.functions.getErrorMessage('field6', dataModel.studentLoginAge, errorField, [], 'Enter age for student login')}
            />
            ...
            <View >
              <NewScreenDropDownPicker
                ...
                errorMessage={GeneralUtils.functions.getErrorMessage('field7', dataModel.communicationLanguage, errorField, [], 'Notification Language')}
            ...
            <View>
              <NewScreenDropDownPicker
                ...
                errorMessage={GeneralUtils.functions.getErrorMessage('field8', dataModel.currencyCode, errorField, [], 'Currency')}
              />
            </View>
            ...
            <View style={[AppStyles.marginTop_1]}>
              ...
              <SuggestionTextInput
                ...
                errorMessage={GeneralUtils.functions.getErrorMessage('field9', dataModel.timezone, errorField, [], 'Time Zone')}
            ...
            <View style={[AppStyles.marginTop_1]}>
              ...
              <SuggestionTextInput
                ...
                errorMessage={GeneralUtils.functions.getErrorMessage('field10', dataModel.countryCode, errorField, [], 'Country')}
