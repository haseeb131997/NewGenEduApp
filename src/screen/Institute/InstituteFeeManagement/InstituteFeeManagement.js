...
class InstituteFeeManagement extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      // feeBreakupEmptyrecord  state configuration
      ...
      primaryKeyCols: ['instituteID', 'feeID'],
      ...
      summaryService: 'InstituteFeeManagementSummary',
      ...
      ivas: '',
      uhtuliak: '',
      CreateDefaultDataModel: { feeID: '' },

      // starts 3.0 UI/UX
      intialFetching: false,
      createStepsHeading: ['Basic Info', 'Breakup Details', 'Notification', 'Remarks', 'Completed'],
      summaryResultByFilter: [],
      errorField: [],
      breadcrumb: 'Menu / Fee Management / Fee Configuration',
      viewDetail: null,
      showComplete: false,
      ...
      welComeTitle: 'Fee Configuration',
  ...
  async setUnmount(unMount) {
    ...
    await apiCall.functions.cancelToken.cancel('Fee Configuration api is being canceled');
  ...
  async setMount(unMount) {
    ...
    this.setState({
      ...
      feeBreakupEmptyrecord: feeBreakupEmptyrecord,
      currentStep: 1,
      currentOperation: 'SummaryQuery',
      intialFetching: true,
    ...
    return (unMount == false && dataModel != null) ? (
      <Provider>
        <ScreenTemplate
          ...
          viewHeading={dataModel.feeDescription}
        ...
        <ChildRecordListModal
          ...
          viewHeading={childViewDetails != null && `${childViewDetails.feeType}`}
          CreateTemplate ={CreateTemplate.functions.CreateConfig(this)}
          EditTemplate={EditTemplate.functions.ModificationConfig(this)}
          ViewTemplate={ViewTemplate.functions.QueryConfig(this)}
          AuthTemplate={AuthTemplate.functions.AuthorisationConfig(this)}
          queryTitle={dataModel.feeDescription}
