...
import InstituteActivityEventFilter from './InstituteActivityEventFilter';
...
QueryTemplate.QueryMandatory = function (stateObject) {
  switch (stateObject.state.currentStep) {
    case 1:
      if ((stateObject.state.summaryDataModel.filter.assignee == '' || stateObject.state.summaryDataModel.filter.assignee == null)
        && (stateObject.state.summaryDataModel.filter.activityType == '' || stateObject.state.summaryDataModel.filter.activityType == null)
        ) {
...
QueryTemplate.QueryConfig = function (stateObject) {
  return (<InstituteActivityEventFilter stateObject={stateObject}/>)
}
