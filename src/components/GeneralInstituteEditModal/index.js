...
class GeneralInstituteEditModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: true
    ...
    return (
      <Portal>
        <Modal visible={secondModalVisible}
          onDismiss={() =>SubScreenUtils.functions.instituteCloseModal(stateObject)}
          ...
          <View style={[styles.modalContainer]}>
            <Card.Content>
              <View style={[AppStyles.row_space_between, AppStyles.marginVertical_1, AppStyles.alignItems]}>
                ...
                <TouchableOpacity onPress={() => SubScreenUtils.functions.instituteCloseModal(stateObject)}>
...
export default GeneralInstituteEditModal
