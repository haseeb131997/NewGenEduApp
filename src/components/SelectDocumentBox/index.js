...
const SelectDocumentBox = (props) => {
  ...
  return (
    ...
    <Dialog visible={visible} onDismiss={()=> stateObject.childStateChange({
      ...
      <Dialog.Title>Choose file to upload</Dialog.Title>
      <Divider/>
      <Dialog.Content>
        <TouchableOpacity onPress={()=>onChange('document')} 
...
export default SelectDocumentBox
